    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ContosoUniversity.DAL.SchoolContext>
    {
        ...
        protected override void Seed(ContosoUniversity.DAL.SchoolContext context)
        {
            var students = new List<Student>
            {
                ...
                new Student{FirstMidName = "Gytis",LastName = "Barzudkas",EnrollmentDate=DateTime.Parse("2012-09-01")},
            ...
            var instructors = new List<Instructor>
            {
                ...
                new Instructor {FirstMidName = "Fadi", LastName = "Fakhouri", HireDate = DateTime.Parse("2007-07-06") },
            ...
            var officeassignmets = new List<OfficeAssignment>
            {
            ...
            officeassignmets.ForEach(s => context.OfficeAssignments.AddOrUpdate(p => p.InstructorID, s));
            context.SaveChanges();
